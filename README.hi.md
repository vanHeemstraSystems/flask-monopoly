...
5) यदि अस्तित्व में नहीं है, तो अंदर एक आभासी वातावरण बनाएं`flask_app` directory: `$ python3 -m venv .venv`6) आभासी वातावरण प्रारंभ करें और दर्ज करें:`$ . .venv/bin/activate`7) भागो`(.venv) $ ./setup.sh` (macOS or Linux)or `(.venv) setup.bat`(विंडोज़)
...
**चेतावनी**: प्रयोग अवश्य करें`pyScss` version 1.3.7 (**नहीं**1.4.0) क्योंकि यह एक बग को फिर से प्रस्तुत करेगा ("वैश्विक झंडे स्थिति 1 पर अभिव्यक्ति की शुरुआत में नहीं हैं")।**अद्यतन**: उपयोग[libsass](https://sass.github.io/libsass-python/)के बजाय`pyScss`.
